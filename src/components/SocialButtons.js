    ...
    render() {
        return(
            <Row style={this.props.style}>
                <ul className="nav" style={{width: "100%", display: "flex", justifyContent: (this.props.justifyContent === undefined ? "center" : this.props.justifyContent), fontSize: "1.2rem;"}}>
                    <a href="https://www.linkedin.com/in/kelvinkellner/" rel="noreferrer" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{margin: "0 -8px 0 0"}}>
                    ...
                    <a href="https://github.com/kelvinkellner" rel="noreferrer" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{margin: "0 -8px 0 24px"}}>
                        ...
                        <li className="nav-item"><a href="https://github.com/kelvinkellner" rel="noreferrer" target="_blank">github</a></li>
