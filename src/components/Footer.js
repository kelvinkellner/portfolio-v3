                ...
                <Row>
                    <ul className="nav" style={{width: "100%", display: "flex", justifyContent: "center", fontSize: "1.2rem;"}}>
                        <a href="https://www.linkedin.com/in/kelvinkellner/" rel="noreferrer" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{margin: "0 -2px 0 0"}}>
                        ...
                        <a href="https://github.com/kelvinkellner" rel="noreferrer" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{margin: "0 -2px 0 22px"}}>
