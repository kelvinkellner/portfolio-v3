...
class Home extends Component {
    render() {
        return (
            <Container id="home">
                <Row>
                    <h4 className="font-weight-bold">passionate about learning & creating<span>.</span></h4>
                    <p>
                        <a href='javascript:smileyEasterEgg()'>Hello!</a> <svg id="smiley" style={{visibility: "hidden", margin: "-16px"}} xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                    ...
                    <p>
                        Feel free to browse through some of the projects I have been working on, and do not feel shy to <a href="mailto:kelvinkellner123@gmail.com" rel="noreferrer" target="_blank">contact me</a>.</p>
                </Row>
                <Row>
